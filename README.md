...
- 🎤 Committee Member & MC for LKMM Pra-TD event
...
- 🏆 Appreciation Certificate from **MK-CSIRT (Mahkamah Konstitusi RI)** for reporting an Information Disclosure vulnerability on `contract.mkri.id` | [View Certificate](https://certificate.mkri.id/validate/qrcode/525-6a5707e9d16b1-MTc4NDUzODUwOA==)
